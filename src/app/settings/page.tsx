    ...
    <Gate>
      <main className="mx-auto max-w-3xl px-4 md:px-6 py-10 space-y-6">
        ...
        <section className="card p-5 space-y-3"><div className="serif text-xl">AI preferences</div>
          ...
          <p className="text-xs text-ink-3">Model: {provider ? `${provider.provider} · ${provider.model}${provider.live ? "" : " (offline heuristic engine — connect a provider in .env for full AI)"}` : "…"}</p>
        </section>
